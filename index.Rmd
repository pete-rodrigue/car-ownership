...
If we add up the number of 8'x22' parking spaces required for these 315,319 vehicles, we get a total area of 2 square miles (176 sqft * 315,319 vehicles * 3.58701e-8 sqmi/sqft). If you parked all of these vehicles bumper to bumper, they would cover Capitol Hill. 

All 344,088 vehicles would cover closer to 2.2 square miles. 
...
private_vehicles_poly <- make_polygon(center_lat, center_lon, sqmi = 2)
...
leaflet() |>
  ...
  addPolygons(
    ...
    fillColor  = "#B22222",
    fillOpacity = 0.2,
    label      = "All private vehicles (~2 sq mi)"
  ) |>
